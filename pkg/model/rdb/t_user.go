...
var TUserWhere = struct {
	...
	Name:      whereHelperstring{field: "`t_user`.`name`"},
	Age:       whereHelperuint8{field: "`t_user`.`age`"},
	CountryID: whereHelperuint8{field: "`t_user`.`country_id`"},
...
var (
	tUserAllColumns            = []string{"id", "name", "age", "country_id", "created_at", "updated_at"}
	tUserColumnsWithoutDefault = []string{"name"}
	tUserColumnsWithDefault    = []string{"id", "age", "country_id", "created_at", "updated_at"}
