...
var (
	tUserWorkHistoryAllColumns            = []string{"id", "user_id", "company_id", "title", "description", "tech_ids", "started_at", "ended_at", "created_at", "updated_at"}
	tUserWorkHistoryColumnsWithoutDefault = []string{"user_id", "company_id", "title", "description", "tech_ids", "started_at", "ended_at"}
	tUserWorkHistoryColumnsWithDefault    = []string{"id", "created_at", "updated_at"}
